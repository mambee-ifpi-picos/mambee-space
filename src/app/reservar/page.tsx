          ...
          if (!usuario.admin) {
            ...
            if (resProj.ok) {
              ...
              if (Array.isArray(projetos)) {
                ...
                setPodeReservar(false);
              }
            } else {
              setPodeReservar(false);
            }
          } else {
            setPodeReservar(true);
          }
        }
      } else {
        setPodeReservar(false);
  ...
  return (
    <>
      ...
      <div className="flex justify-center items-start mt-5 pb-10 w-full px-4">
        {!authLoading && idUsuarioAuth && !podeReservar && !isAdmin ? (
          <div className="bg-white shadow-md rounded-xl w-full max-w-2xl border border-gray-300 p-12 text-center mt-10">
            <h2 className={`${inriaSerif700.className} text-3xl text-gray-900 mb-4`}>Acesso Negado</h2>
            <p className="text-gray-600 mb-8 text-lg">
              Você só pode fazer uma reserva se estiver participando de um projeto ativo.
            </p>
            <Link
              href="/projetos"
              className="inline-block px-8 py-3 bg-teal-500 hover:bg-teal-600 text-white font-bold rounded-xl transition-colors shadow-sm"
            >
              Ver Projetos
            </Link>
          </div>
                ...
                {carregandoMapa ? (
                  ...
                  <div className="text-gray-400 flex flex-col items-center">
                    ...
                    <span className="text-sm mt-1">
                      {salaSelecionada ? "Sem mapa disponível" : "Selecione uma sala"}
                    </span>
                  </div>
                )}
              </div>
