  ...
  return (
    <footer className="w-full bg-gray-50 pt-12 border-t border-gray-100 text-gray-700 font-sans">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-10 pb-12 text-left">
        <div className="flex flex-col space-y-4">
          ...
          <div className="flex space-x-4 mt-2">
            <a
              href="https://github.com/mambee-ifpi-picos/mambee-space#"
              target="_blank"
            ...
            <a
              ...
              target="_blank"
              className="text-gray-600 hover:text-pink-600 text-2xl transition-colors"
            >
              <FaInstagram />
            </a>
          </div>
        ...
        <div>
          ...
          <ul className="space-y-4 text-sm md:text-base">
            ...
            <li>
              <Link href="/#sobre" className="hover:text-pink-500 transition-colors">
                About
              </Link>
            </li>
          </ul>
      ...
      <div className="w-full bg-pink-200 py-4 text-center border-t border-pink-300">
        <p className="text-gray-700 text-xs md:text-sm font-medium">© 2025 Mambee Space</p>
      </div>
    </footer>
  );
}
